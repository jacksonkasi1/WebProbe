export type CrawlSeverity = "high" | "medium" | "low";
...
export type CrawlScanResult = {
  ...
  groupedIssues: (CrawlIssue & { count: number; urls: string[] })[];
...
export type CrawlArgs = {
  ...
  onProgress?: (scanned: number, queue: number, currentUrl: string) => void;
};
